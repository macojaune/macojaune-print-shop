...
test('amber alert stays local, low in amplitude, slow, and disappears after the truck is upright',()=>{
  ...
  assert.equal(sampleSignals(400,{completed:['inscrits']}).alertLevel,0);
});
