---
name: "Maco’misyon · Dépôt Q · v5"
description: "Console Maco Pocket et entrepôt miniature en activité à chaque visite."
colors:
  yellow: "#ffc52c"
  panel-action: "#ffd04a"
  ink: "#151d19"
...
components:
  ...
  motion-control:
    ...
    rounded: "{rounded.game-control}"
    padding: "8px 10px"
  motion-control-paused:
    backgroundColor: "#e4c46c"
    textColor: "#1b2d23"
---

# Design System: Maco’misyon · Dépôt Q · v5

## Overview

**Creative North Star: "La console du dépôt Q"**

La v5 conserve l'identité et la géométrie approuvées de la v4. Tanker, Space et le jaune Macojaune restent l'identité de la console ambre. Le monde est un entrepôt miniature procédural vu en projection orthographique, avec un Fenwick renversé, une palette et des colis au sol.

Les panneaux verts reprennent un terminal de jeu à cadres courts et coins décrochés. L'inventaire, les icônes et les compteurs montrent les acquis et les réserves. Les transformations du chariot et de la cargaison rendent les réussites visibles dans le lieu. La v5 prolonge chaque état par une activité locale. Le dépôt réparé reprend ses tournées à chaque visite, sans répéter les annonces de réussite.

Impeccable documente l'interface et ses contrôles. L'animation et l'éclairage procéduraux s'appuient sur les références Three.js Animation et Three.js Lighting citées dans README.md, consultées sans installation globale.
...
- Tournées du Fenwick, signaux locaux et pause persistante accessible sur la carte.
...
Les valeurs complètes des ombres sont conservées dans le sidecar. Les panneaux apparaissent avec un déplacement de 18px sur .25s. La caméra rejoint un point en 650ms ; une réparation intermédiaire dure 1150ms, l'expédition finale 5500ms. Le mouvement réduit supprime les transitions CSS et applique directement les poses et la position de caméra. Après l'expédition initiale, une tournée de 22 secondes répète chargement, trajet chargé, déchargement et retour à vide. Les cycles ne modifient pas les acquis.

Deux lampes industrielles ambre signalent l'accident avec une variation sinusoïdale de 5,6 secondes. Une seule lumière ponctuelle, sans ombre et de portée limitée, éclaire leurs abords. Le fond du dépôt reste stable. Le scanner accompagne les recommandations acquises ; les repères ouverts ou accomplis et les témoins de Q ont leurs propres variations lentes. Les repères verrouillés restent discrets.

L'ambiance est plafonnée à 30 images par seconde. La caméra et les réparations suivent le rafraîchissement de l'écran. L'horloge s'arrête dans un onglet masqué ou hors champ, puis reprend sans rattrapage. Ce plafond ne constitue pas une mesure de performance sur téléphone.
...
- Le contrôle de mouvement se place en bas à gauche de la carte, au-dessus de l'aide. Il mesure au moins 91 × 44px, avec une icône de 15px et un libellé Space de 10px. « Pause » fige l'activité et les variations lumineuses ; « Reprendre » conserve la position de la tournée. Le choix est mémorisé séparément de l'avancement. La même commande figure dans la console. En mouvement réduit, elle affiche « Mode calme » et reste désactivée ; les missions et les déplacements de caméra restent accessibles.
...
- Dans le monde, les inscrits redressent Q, les recommandations réunissent sa cargaison, puis les trois principales accomplies ouvrent le rideau et expédient les colis. Le quai reste ouvert pendant les tournées suivantes ; Q revient à vide chercher une nouvelle palette. Le bonus ajoute son chargement et ses touches de décor indépendamment. Les acquis restent présents après rechargement lorsque le stockage local est disponible.
...
- Do garder une activité lisible à chaque visite et une commande pour la suspendre.
...
- Don't faire varier l'éclairage général ni ajouter de flashes rapides.
- Don't rejouer une réussite ou remettre le dépôt en panne au début d'une tournée.
