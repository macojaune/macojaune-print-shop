...
import { J as eventHandler, K as setResponseHeader, L as send, M as getResponseStatus, N as setResponseStatus, O as useNitroApp, P as setResponseHeaders, Q as joinRelativeURL, u as useRuntimeConfig, r as getQuery, s as createError, R as getRouteRules, S as getResponseStatusText } from './api/checkout.mjs';
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[],"style":[],"script":[],"noscript":[],"charset":"utf-8","viewport":"width=device-width, initial-scale=1","title":"Macojaune.com","htmlAttrs":{"lang":"fr"}};
