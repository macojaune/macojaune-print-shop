...
import { u as useContentDisabled, q as queryContent, w as withContentBase, e as encodeQueryParams, a as addPrerenderPath, s as shouldUseClientDB, j as jsonStringify } from './query-x0nbLBj8.mjs';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-BRdMlWXh.mjs').then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-5oh2BVTn.mjs.map
